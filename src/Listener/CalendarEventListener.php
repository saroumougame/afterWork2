...
class CalendarEventListener
{
    ...
    public function loadEvents(CalendarEvent $calendarEvent )
    {
        ...
        //    $url = $this->container->get('router')->generate('gas_business_demande_show',  array('id' => $id), UrlGeneratorInterface::ABSOLUTE_URL);
            ...
            $eventEntity->setUrl('google.fr'); // url to send user to when event label is clicked
